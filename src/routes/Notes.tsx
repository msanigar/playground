...
function StatsPanel({ statsPromise }: { statsPromise: Promise<NotesStats> }) {
  ...
  return (
    <motion.div
      className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-700/50 p-2 lg:p-6 space-y-2 lg:space-y-4"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5 }}
    >
      <h3 className="text-base lg:text-lg font-semibold text-gray-800 dark:text-gray-200 mb-1 lg:mb-4">Statistics</h3>
      ...
      <div className="hidden lg:grid grid-cols-2 gap-4 text-sm">
        <div className="text-center p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
          ...
          <div className="text-gray-600 dark:text-gray-400 text-sm">Notes</div>
        </div>
        ...
        <div className="text-center p-3 bg-purple-50 dark:bg-purple-900/30 rounded-lg">
          ...
          <div className="text-gray-600 dark:text-gray-400 text-sm">Avg/Note</div>
        </div>
      ...
      {/* Mobile Statistics - Ultra Compact */}
      <div className="lg:hidden flex justify-between items-center text-xs bg-gray-50 dark:bg-gray-800/50 rounded-lg p-2">
        <span className="text-blue-600 dark:text-blue-400 font-semibold">{stats.totalNotes} notes</span>
        <span className="text-green-600 dark:text-green-400 font-semibold">{stats.totalWords} words</span>
        <span className="text-purple-600 dark:text-purple-400 font-semibold">{stats.avgWordsPerNote} avg</span>
      </div>

      <div className="pt-3 lg:pt-4 border-t border-gray-200/50 dark:border-gray-600/50 space-y-1 lg:space-y-2 text-xs text-gray-600 dark:text-gray-400 hidden lg:block">
...
export default function Notes() {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-7.5rem)] lg:h-[calc(100vh-7.5rem)] flex flex-col lg:flex-row gap-4 lg:gap-6 overflow-y-auto lg:overflow-hidden">
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col space-y-3 lg:space-y-6 min-h-0 order-first">
      ...
      {/* Sidebar - Responsive */}
      <div className="lg:w-80 space-y-1 lg:space-y-6 order-last flex-shrink-0">
        ...
        <motion.div
          className="hidden lg:block bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-700/50 p-6"
